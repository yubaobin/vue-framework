        ...
        <div class="content-wrapper b-wrapper">
            ...
            <div class="table-container">
                ...
                <el-table :data="tableData">
                    <el-table-column prop="id" label="日期" width="360" align="center" >
                        <template slot-scope="scope">
                            <div class="img-block">
                                <img class="img-bd" :src="scope.row.video.img " />
                                <div class="c-bd">
                                    <p class="f-green">{{ scope.row.video.name }}</p>
                                    <p>{{ scope.row.video.date }}</p>
                                </div>
                            </div>
                        </template>
                    </el-table-column>
