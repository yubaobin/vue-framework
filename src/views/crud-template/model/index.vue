...
<template>
    <div>
        ...
        <div class="opr-container">
            <el-button type="primary" @click="addItemByModel">新增</el-button>
            <el-dropdown
        ...
        <table-panel
            ...
            <el-table-column label="操作" align="center" width="200">
                <template v-slot="{ row }">
                    <el-button type="text" @click.stop="viewItemByModel(row)">查看</el-button>
                    <el-button type="text" @click.stop="editItemByModel(row)">编辑</el-button>
        ...
        <add-or-edit-model
            ref="CrudTemplateCrudModelAddOrEditModel"
            @on-success="handleAddOrEditSuccess"></add-or-edit-model>
        <detail-model ref="CrudTemplateCrudModelDetailModel"></detail-model>
    </div>
</template>
...
import AddOrEditModel from './add-or-edit-model'
...
export default {
    ...
    data () {
        return {
            ...
            addOrEditModelName: 'CrudTemplateCrudModelAddOrEditModel',
            detailModelName: 'CrudTemplateCrudModelDetailModel',
            query: {
                productVo: {
                    name: ''
                }
